...
class Car
{
     ...
     public function getListOfCarsByParams($searchcontact)
    {
          ...
          $sql = mysqli_query($this->conn,"select AutoShop.id, AutoShop.marka, AutoShop.model, AutoShop.year_car, AutoShop.engine_capacity, AutoShop.color, AutoShop.max_speed, AutoShop.price  (AutoShop.id like '%$searchcontact%')
